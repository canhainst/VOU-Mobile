...
class MainViewModel() : ViewModel() {
    ...
    fun loadFavoriteEvents(){
        ...
        val list : List<Event> = listOf(Event(null, "Cuoi Thang 7", "Phúc Long", "https://phuclong.com.vn/upload/files/a4%20htk-02.jpg", 100, "18:00 26/07/2024", "18:00 30/08/2024", 0, ""),
